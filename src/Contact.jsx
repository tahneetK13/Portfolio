...
const Contact = () => {
  return (
    <div
    id="contact"
    className="hero2-box w-full h-screen "
  >
    <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
      ...
      <div className=" flex justify-center items-center">
        ...
        >
          ...
          <button className="text-gray-800 bg-gradient-to-b from-lilic to-sky px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300">
            Let's talk
          </button>
        </form>
      </div>
